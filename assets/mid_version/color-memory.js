...
function endGame() {
    ...
    const scoreInterval = setInterval(() => {
        ...
        if (displayScore >= averageScore) {
            ...
            if (averageScore >= 95) { gradeText.innerText = "Nearly perfect!";
            } else if (averageScore >= 90) { gradeText.innerText = "Nearly perfect!";
            } else if (averageScore >= 80) { gradeText.innerText = "Nearly perfect!";
            } else if (averageScore >= 70) { gradeText.innerText = "Good job!";
            } else if (averageScore >= 60) { gradeText.innerText = "Good job!";
            } else if (averageScore >= 50) { gradeText.innerText = "Meh, not bad.";
            } else if (averageScore >= 40) { gradeText.innerText = "Meh, not bad.";
            } else if (averageScore >= 30) { gradeText.innerText = "Keep trying...";
            } else if (averageScore >= 20) { gradeText.innerText = "Keep trying...";
            } else if (averageScore >= 10) { gradeText.innerText = "Keep trying...";
